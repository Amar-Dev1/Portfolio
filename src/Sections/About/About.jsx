        ...
        <Row className="d-flex justify-content-center">
          <Col lg={6} md={12} sm={12}>
            ...
            <div className='about-phrase'>
              <p>
              A Passionate computer science student, driven to excel in software engineering and make a positive impact in the industry. I have worked with : javascript, python, Bootstrap, React.js, django, mysql and git & github.</p>
            </div>
          </Col>
